    ...
    <jsp:body>
        ...
        <div class="col-md-11" id="divPaymentForm">
            <form action="LoadCompleteOrder" method="POST">
                <div class="col-sm-4">
                    <button alt="Quay lại trang quản lý" class="btn btn-info" name="btnAction" value="cancel" type="submit" style="width: 205px">Quay lại</button>
                </div>
                <div class="col-sm-4">
                    <input type="hidden" name="consignmentID" value="${product.consignmentID}">
                    <button alt="Khách hàng đã mua hàng" class="btn btn-warning" name="btnAction" value="complete" type="submit" style="width: 205px">Đã mua hàng</button>
                </div>
            </form>
        </div>
    </div>
