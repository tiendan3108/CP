            ...
            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                ...
                <tbody>
                    <c:if test="${empty consignments}">
                        <tr>
                            <td colspan="5">There is no imported product.</td>
                        </tr>
                    </c:if>
                    <c:forEach var="c" items="${consignments}">
                        <tr>
                            ...
                            <td>
                                <fmt:formatDate type="date" dateStyle="long" value="${c.importDate}"/>
                            </td>
                            <td>
                                <fmt:formatNumber type="currency" currencySymbol="$" value="${c.consignPrice}" />
                            </td>
                            <td>
                                <fmt:formatNumber type="currency" currencySymbol="$" value="${c.product.price}"/>
                            </td>
                            <td>
