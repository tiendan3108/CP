    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
        ...
        <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5 col-sm-5 input-daterange">
                                                    <input type="text" class="form-control" id="dateRangeExpired">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-md-offset-6 col-sm-offset-6">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-md-3 col-sm-3 col-md-offset-4 col-sm-offset-4 control-label">Lọc ngày:</label>
                                                <div class="col-md-5 col-sm-5 input-daterange">
                                                    <input type="text" class="form-control" id="dateRangeAvailable">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <table class="table table-bordered table-hover" id="availableTable">
                                    <thead>
                                        <tr class="heading">
                                            <th>STT</th>
                                            <th>Tên sản phẩm</th>
                            ...
                            <!-- END AVAILABLE TAB-->
                            <!-- BEGIN ONWEB TAB-->
                            <div id="onWeb" style="display: none;">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-md-offset-6 col-sm-offset-6">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-md-3 col-sm-3 col-md-offset-4 col-sm-offset-4 control-label">Lọc ngày:</label>
                                                <div class="col-md-5 col-sm-5 input-daterange">
                                                    <input type="text" class="form-control" id="dateRangeOnWeb">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <table class="table table-bordered table-hover" id="onWebTable">
                                    <thead>
                                        <tr class="heading">
                                            <th>STT</th>
                                            <th>Tên sản phẩm</th>
                            ...
                            <div id="ordered" style="display: none;">
                                <table class="table table-bordered table-hover" id="orderedTable">
                                    <thead>
                                        <tr class="heading">
                                            <th>STT</th>
                                            <th>Tên sản phẩm</th>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-md-offset-6 col-sm-offset-6">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-md-3 col-sm-3 col-md-offset-4 col-sm-offset-4 control-label">Lọc ngày:</label>
                                                <div class="col-md-5 col-sm-5 input-daterange">
                                                    <input type="text" class="form-control" id="dateRangeCanceled">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <table class="table table-bordered table-hover" id="canceledTable">
                                    <thead>
                                        <tr class="heading">
                                            <th>STT</th>
                                            <th>Tên sản phẩm</th>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-md-offset-6 col-sm-offset-6">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-md-3 col-sm-3 col-md-offset-4 col-sm-offset-4 control-label">Lọc ngày:</label>
                                                <div class="col-md-5 col-sm-5 input-daterange">
                                                    <input type="text" class="form-control" id="dateRangeSold">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#dateRangeExpired').daterangepicker({
                        format: "DD/MM/YYYY",
                        startDate: moment(),
                        endDate: moment(),
                        locale: {cancelLabel: 'Đóng', applyLabel: 'Lọc', fromLabel: 'Từ ngày', toLabel: 'Đến ngày'}
                    });
                    $('#dateRangeAvailable').daterangepicker({
                        format: "DD/MM/YYYY",
                        startDate: moment(),
                        endDate: moment(),
                        locale: {cancelLabel: 'Đóng', applyLabel: 'Lọc', fromLabel: 'Từ ngày', toLabel: 'Đến ngày'}
                    });
                    $('#dateRangeOnWeb').daterangepicker({
                        format: "DD/MM/YYYY",
                        startDate: moment(),
                        endDate: moment(),
                        locale: {cancelLabel: 'Đóng', applyLabel: 'Lọc', fromLabel: 'Từ ngày', toLabel: 'Đến ngày'}
                    });
                    $('#dateRangeCanceled').daterangepicker({
                        format: "DD/MM/YYYY",
                        startDate: moment(),
                        endDate: moment(),
                        locale: {cancelLabel: 'Đóng', applyLabel: 'Lọc', fromLabel: 'Từ ngày', toLabel: 'Đến ngày'}
                    });
                    $('#dateRangeSold').daterangepicker({
                        format: "DD/MM/YYYY",
                        startDate: moment(),
                        endDate: moment(),
                        locale: {cancelLabel: 'Đóng', applyLabel: 'Lọc', fromLabel: 'Từ ngày', toLabel: 'Đến ngày'}
                ...
                $.fn.dataTable.ext.search.push(
                        function (settings, data, dataIndex) {
                            ...
                            if (startDate == "" || endDate == "" || currentTab.localeCompare('ordered') == 0) {
                                return true;
                            } else {
                                var date = data[3];
                ...
                $('#dateRangeExpired').on('apply.daterangepicker', function (ev, picker) {
                    var table = $('#expiredTable').DataTable();
                    var startDate = $('#dateRangeExpired').data('daterangepicker').startDate.format('DD-MM-YYYY');
                    var endDate = $('#dateRangeExpired').data('daterangepicker').endDate.format('DD-MM-YYYY');
                    $('#fromDate').val(startDate);
                    $('#toDate').val(endDate);
                    table.draw();
                });
                $('#dateRangeAvailable').on('apply.daterangepicker', function (ev, picker) {
                    var table = $('#availableTable').DataTable();
                    var startDate = $('#dateRangeAvailable').data('daterangepicker').startDate.format('DD-MM-YYYY');
                    var endDate = $('#dateRangeAvailable').data('daterangepicker').endDate.format('DD-MM-YYYY');
                    $('#fromDate').val(startDate);
                    $('#toDate').val(endDate);
                    table.draw();
                });
                $('#dateRangeOnWeb').on('apply.daterangepicker', function (ev, picker) {
                    var table = $('#onWebTable').DataTable();
                    var startDate = $('#dateRangeOnWeb').data('daterangepicker').startDate.format('DD-MM-YYYY');
                    var endDate = $('#dateRangeOnWeb').data('daterangepicker').endDate.format('DD-MM-YYYY');
                    $('#fromDate').val(startDate);
                    $('#toDate').val(endDate);
                    table.draw();
                });
                $('#dateRangeCanceled').on('apply.daterangepicker', function (ev, picker) {
                    var table = $('#canceledTable').DataTable();
                    var startDate = $('#dateRangeCanceled').data('daterangepicker').startDate.format('DD-MM-YYYY');
                    var endDate = $('#dateRangeCanceled').data('daterangepicker').endDate.format('DD-MM-YYYY');
                    $('#fromDate').val(startDate);
                    $('#toDate').val(endDate);
                    table.draw();
                });
                $('#dateRangeSold').on('apply.daterangepicker', function (ev, picker) {
                    var table = $('#soldTable').DataTable();
                    var startDate = $('#dateRangeSold').data('daterangepicker').startDate.format('DD-MM-YYYY');
                    var endDate = $('#dateRangeSold').data('daterangepicker').endDate.format('DD-MM-YYYY');
                    $('#fromDate').val(startDate);
                    $('#toDate').val(endDate);
                    table.draw();
                });
